...
class IntelligentCruiseButtonManagement:
  ...
  def update_readiness(self, CS: car.CarState, CC: car.CarControl) -> None:
    ...
    # MADS lateral-only cars steer with latActive=True but enabled=False (no openpilot
    # longitudinal). Treat lateral engagement as sufficient for ICBM to manage set-speed.
    engaged = CC.enabled or CC.latActive
