...
from openpilot.sunnypilot.selfdrive.car.toyota.accel_smoother import AccelSmoother
...
def _wrap_toyota_accel(CI: CarInterfaceBase) -> None:
  ...
  def apply(c, c_sp, now_nanos=None):
    ...
    c_b = c.as_builder()
    c_b.actuators.accel = smoothed
    return CI.CC.update(c_b, c_sp, CI.CS, now_nanos)
